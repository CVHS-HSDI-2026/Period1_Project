...
async function main() {
  ...
  const robotics = await prisma.club.create({
    data: {
      ...
      advisorName: "Mr. Roberts",
      advisorEmail: "mrRoberts@gmail.com",
      officerEmail: [alice.email],
  ...
  const keyClub = await prisma.club.create({
    data: {
      ...
      advisorName: "Ms. Chen",
      advisorEmail: "msChen@gmail.com",
      officerEmail: [charlie.email],
  ...
  const drama = await prisma.club.create({
    data: {
      ...
      otherLinks: [],
      tags: ["Arts", "Theater"],
      advisorName: "Mrs. Patel",
      advisorEmail: "mrsPatel@gmail.com",
      officerEmail: [charlie.email],
